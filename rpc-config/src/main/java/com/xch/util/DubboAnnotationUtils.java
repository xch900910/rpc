...
public class DubboAnnotationUtils {
    ...
    @Deprecated
    public static String resolveInterfaceName(RpcService service, Class<?> defaultInterfaceClass)
    ...
    @Deprecated
    public static String resolveInterfaceName(RpcReference reference, Class<?> defaultInterfaceClass)
            throws IllegalStateException {
